...
moment.addWorkingTime = addOrSubtractMethod(add);
moment.subtractWorkingTime = addOrSubtractMethod(subtract);

moment.isBusinessDay = function isBusinessDay() {
    var hours = getLocaleData('workinghours');
    return !!hours[this.day()] && !this.isHoliday();
};
moment.isWorkingDay = moment.fn.isBusinessDay;

moment.isWorkingTime = function isWorkingTime() {
...
moment.nextWorkingDay = function nextWorkingDay() {
    var d = this.clone();
    d = d.add(1, 'day');
...
moment.lastWorkingDay = function nextWorkingDay() {
    var d = this.clone();
    d = d.subtract(1, 'day');
    while (!d.isWorkingDay()) {
        d = d.subtract(1, 'day');
...
moment.nextWorkingTime = function nextWorkingTime() {
...
moment.lastWorkingTime = function nextWorkingTime() {
    if (this.isWorkingDay()) {
        var openinghours = openingTimes(this);
...
moment.workingDiff = function workingDiff(comparator, unit, detail) {
